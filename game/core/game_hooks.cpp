...
static bool vagrant_hasNativeHandlerForEntry(Core*, uint32_t) { return false; }  // truthfully: none
static int  vagrant_devAreaCount(Core*)            { return 0; }   // truthfully: no area index RE'd
static const char* vagrant_devAreaName(Core*, int) { return ""; }  // "" == no sourced name
static bool vagrant_devWarpAllowed(Core*)          { return false; }
...
static void vagrant_frameUpdate(Core*)         { unstood_up("frameUpdate (native frame loop)"); }
static void vagrant_drawOTag(Core*, uint32_t)  { unstood_up("drawOTag (native frame loop)"); }
static int  vagrant_schedStageBody(Core*, int, void*) { unstood_up("schedStageBody (PcScheduler)"); return 0; }
static bool vagrant_schedFreshEntry(Core*, int, uint32_t, uint32_t) { unstood_up("schedFreshEntry (PcScheduler)"); return false; }
static void vagrant_devWarpAreaLoad(Core*)     { unstood_up("devWarpAreaLoad (dev warp)"); }
...
static const GameHooks g_vagrant_hooks = {
    ...
    .devWarpAreaLoad          = vagrant_devWarpAreaLoad,
...
const GameHooks* vagrant_game_hooks() { return &g_vagrant_hooks; }
