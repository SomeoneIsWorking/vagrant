...
// contract; success means every requested byte was copied from the CHD. Code-image identity and
// invalidation are separate responsibilities of OverlayImages at the title loader handoff.
