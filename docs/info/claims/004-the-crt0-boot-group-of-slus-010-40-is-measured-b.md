...
4. NOTHING HAS EVER EXECUTED THIS BOOT GROUP. There is no substrate and no port binary. "Measured" here means "this is what crt0 does to this image", not "the port boots with it".
