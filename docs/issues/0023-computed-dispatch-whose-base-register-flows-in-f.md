...
psxport cab5d077 converged cross-fragment completion over the whole partition: module-wide dispatch edges plus iterative uncovered-target entry completion pass 0x800B182C/1774. The bounded Start replay advanced to issue #24's new corrupted-pointer boundary, so this exact recomp-MISS is falsified. Framework commit reports resident +161, BATTLE +277, TITLE +4 dispatchable entries and names the real-disc runtime discriminator.
